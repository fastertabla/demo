...
export default function EmbeddedTopLevel() {
  ...
  function getShowTriplePlayOptionsMarkup() {
    ...
    return (
      <div>
        <img src='./assets/img/header3.jpg' />
        <img src='./assets/img/loan1.jpg' />
        <img src='./assets/img/loan2.jpg' />
        <img src='./assets/img/loan3.jpg' />
      ...
      <div className={classes.resolutionPart}>
        <div className={classes.resolutionPartAccompanimentLeft}>
          <div className={classes.resolutionPartAccompanimentText}>
            ...
            <br />
            <br />
            Mortgage Loan application case L-13010 is created. Representative from Lloyds bank will contact you with in the next couple of days to
